...
class CEsquema {
    ...
    public function __construct() {
        $this->bd = Sis::apl()->bd->nombreBD;
        $this->prefijo = Sis::apl()->bd->prefijo;
    }
    ...
    public function obtenerTablas(){
        ...
        $resultado = Sis::apl()->bd->controlador->ejecutarComando($consulta);
        $tablas = [];        
    ...
    public function obtenerAtributos($tabla){
        ...
        $campos = Sis::apl()->bd->controlador->ejecutarComando($consulta);
        return $campos;
    }
    ...
    public function obtenerRelaciones($tabla){
        ...
        $relaciones = Sis::apl()->bd->controlador->ejecutarComando($consulta);
        return $relaciones;
    }
