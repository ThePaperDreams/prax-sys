...
<div class="row">        
    <div class="col-sm-12">
        <?php if(Sis::Sesion()->existeNotificacion("modCreado")): ?>
        <?php 
        $config = Sis::Sesion()->getNotificacion("modCreado");
        ?>
        <div class="alert alert-success">
            ...
            <strong>Acceda al módulo así: <br>
                <a href="<?php echo Sis::apl()->urlBase . "?r=".$config['nombre']; ?>" target="_blank">
                    <?php echo Sis::apl()->urlBase . "?r=".$config['nombre']; ?>
                </a>
            </strong>
        </div>
            <?php echo $config['html'];?>
        <?php elseif(Sis::Sesion()->existeNotificacion("modErr")): ?>
        <div class="alert alert-danger">
            <?php echo Sis::Sesion()->getNotificacion("modErr");?>
        </div>
        <?php endif; ?>
    </div>
</div>
