                    ...
                    <div class="col-sm-offset-1 col-sm-3">
                        <div class="panel panel-primary">
                            ...
                            <div id="options" class="list-group">
                                <a href="<?php echo Sis::apl()->crearUrl(['codegen/generador/modelo'])?>" class="list-group-item"><?php echo CBoot::fa('database'); ?> Generar <b>Modelos</b></a>
                                <a href="<?php echo Sis::apl()->crearUrl(['codegen/generador/crud'])?>" class="list-group-item"><?php echo CBoot::fa('list-alt'); ?> Generar <b>CRUD</b></a>
                                <a href="<?php echo Sis::apl()->crearUrl(['codegen/generador/modulo'])?>" class="list-group-item"><?php echo CBoot::fa('cubes'); ?> Generar <b>Módulos</b></a>
                            </div>
                            <div class="panel-body">
                                <a href="<?php echo Sis::apl()->crearUrl(['codegen/generador/logout']) ?>" class="btn btn-block btn-danger">
