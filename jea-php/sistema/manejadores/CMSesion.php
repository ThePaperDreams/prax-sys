...
class CMSesion {
    ...
    /**
     * Esta función permite crear flashes
     * @param string $nombre
     * @param mixed $valor
     */
    public function flash($nombre, $valor){
        $this->setNotificacion($nombre, $valor);
    }  
    /**
     * Esta función permite obtener flashes por su nombre
     * @param string $nombre
     * @return mixed
     */
    public function getFlash($nombre){
        return $this->getNotificacion($nombre);
    }
    /**
     * Esta función permite validar si existe un flash
     * @param string $nombre
     * @return boolean
     */
    public function hayFlash($nombre){
        return $this->existeNotificacion($nombre);
    }
    /**
     * Esta función permite obtener todos los flashes registrados
     * @return mixed
     */
