...
abstract class CModulo extends CComponenteAplicacion{
    ...
    private static function validarModulo($nombre){
        ...
        $modulos = Sis::apl()->getConfiguracion('modulos');
        ...
        $ruta = Sis::resolverRuta($configuracion['ruta']);
        # archivo que se importará
        $archivo = Sis::resolverRuta($configuracion['ruta'].".$clase", true);
