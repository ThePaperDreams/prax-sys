...
<div id="messages" class="tile drawer animated">
    <div class="listview narrow">
        ...
        <div class="overflow" style="height: 254px">
            <div class="media">
                <div class="pull-left">
                    <img width="40" src="<?= Sis::ap()->getTema()->getUrlBase() ?>/img/profile-pics/1.jpg" alt="">
                </div>
            ...
            <div class="media">
                <div class="pull-left">
                    <img width="40" src="<?= Sis::ap()->getTema()->getUrlBase() ?>/img/profile-pics/2.jpg" alt="">
                </div>
                <div class="media-body">
            ...
            <div class="media">
                <div class="pull-left">
                    <img width="40" src="<?= Sis::ap()->getTema()->getUrlBase() ?>/img/profile-pics/3.jpg" alt="">
                </div>
                <div class="media-body">
            ...
            <div class="media">
                <div class="pull-left">
                    <img width="40" src="<?= Sis::ap()->getTema()->getUrlBase() ?>/img/profile-pics/4.jpg" alt="">
                </div>
                <div class="media-body">
            ...
            <div class="media">
                <div class="pull-left">
                    <img width="40" src="<?= Sis::ap()->getTema()->getUrlBase() ?>/img/profile-pics/5.jpg" alt="">
                </div>
                <div class="media-body">
